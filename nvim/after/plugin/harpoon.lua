...
vim.keymap.set("n", "<C-e>", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, { unique = true })
vim.keymap.set("n", "<leader>a", function() harpoon:list():add() end, { unique = true })
...
vim.keymap.set("n", "<C-g>", function() harpoon:list():prev() end, { unique = true })
vim.keymap.set("n", "<C-h>", function() harpoon:list():next() end, { unique = true })
...
vim.keymap.set("n", "<Leader>pt", function() toggle_telescope(harpoon:list()) end,
    { desc = "Telescope Harpoon List", unique = True })
